...
function WagerPill({
 ...
 type="button"
 onClick={onClick}
 className={`px-5 py-2.5 text-sm rounded-full border transition-all cursor-pointer ${
 isSelected
 ...
 >
 <div className="bg-[#121212]/95 backdrop-blur-xl border border-white/20 px-3 py-1.5 rounded-xl shadow-[0_8px_30px_rgba(0,0,0,0.9)] flex flex-col items-center gap-0.5 text-center">
...
export default function Dashboard() {
 ...
 <div className="inline-block rounded-full px-3 py-1 bg-white/5 border border-white/10 text-[12px] uppercase tracking-[0.2em] font-medium text-text-secondary mb-4">
 Connect 4
 </div>
 )}
 ...
 {user?.isTestUser ? (
 <div className="flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-primary-dim border border-primary/30 text-primary text-xs font-bold">
 <Flask size={16} />
 ...
 className={`flex-1 py-3 text-xs rounded-full transition-all font-semibold uppercase tracking-wider cursor-pointer ${
 wagerType === 'SOL'
 ...
 className="w-full h-12 bg-black/40 border border-white/10 rounded-full px-6 text-sm text-white outline-none focus:border-primary text-center transition-colors"
 />
 ...
 return (
 <div className="w-full bg-red-950/40 border border-red-500/30 rounded-xl p-3 flex items-center justify-between gap-3 text-xs text-red-200">
 ...
 className="px-2.5 py-1 rounded bg-primary/20 hover:bg-primary/30 border border-primary/40 text-white font-bold text-xs flex items-center gap-1 shrink-0 transition-colors"
 >
 <span>Faucet</span>
 ...
 <span className="text-xs italic font-medium text-text-muted px-2">VS</span>
 ...
 className={`group/btn flex items-center justify-between rounded-full h-10 pl-5 pr-1 text-[12px] font-bold uppercase tracking-widest transition-all ease-premium cursor-pointer hover-magnetic ${
 game.status === 'active'
 ...
 <div className="text-center text-text-muted text-sm py-20 border border-white/5 rounded-[2rem] bg-black/20">
