...
export default function UserProfileModal({ userId, onClose }: UserProfileModalProps) {
 ...
 className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-[#202020] hover:bg-[#282828] border border-white/10 hover:border-primary text-xs font-semibold text-white transition-all cursor-pointer shrink-0 whitespace-nowrap"
 ...
 <span className="text-[12px] text-text-muted uppercase block">SOL</span>
