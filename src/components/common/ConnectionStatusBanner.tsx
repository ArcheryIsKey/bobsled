    ...
    <AnimatePresence>
      {isOffline && (
        <motion.div
          ...
          className="fixed top-0 left-0 right-0 z-[9999] bg-gradient-to-r from-red-950/95 via-red-900/95 to-red-950/95 border-b border-red-500/30 text-white px-4 py-2.5 shadow-[0_4px_25px_rgba(255,0,0,0.3)] backdrop-blur-xl flex items-center justify-center font-mono text-xs"
        >
          <div className="max-w-4xl w-full flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-1.5 text-red-300/80 text-[11px] shrink-0 bg-black/40 px-2.5 py-1 rounded-full border border-red-500/20">
      ...
      {!isOffline && showRestoredNotice && (
        <motion.div
          ...
          exit={{ y: -60, opacity: 0 }}
          transition={{ duration: 0.25, ease: 'easeOut' }}
          className="fixed top-0 left-0 right-0 z-[9999] bg-gradient-to-r from-emerald-950/95 via-emerald-900/95 to-emerald-950/95 border-b border-emerald-500/30 text-white px-4 py-2.5 shadow-[0_4px_25px_rgba(16,185,129,0.3)] backdrop-blur-xl flex items-center justify-center font-mono text-xs"
        >
