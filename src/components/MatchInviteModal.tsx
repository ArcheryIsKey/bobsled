              ...
              <div className="space-y-3">
                <div className="p-3.5 rounded-xl bg-amber-500/10 border border-amber-500/30 flex items-start gap-2.5 text-left text-xs text-amber-200">
                  ...
                  <div>
                    ...
                    This match has a stake of <strong className="text-white font-mono">{pendingGame.wager} SOL</strong>. You are currently in Guest Mode. Connect a Solana wallet to place stakes and enter as Player 2.
                  </div>
                </div>
