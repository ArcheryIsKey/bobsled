        ...
        {pendingGame && (
          <div className="w-full mb-5 p-4 rounded-2xl bg-primary/10 border border-primary/40 flex items-center gap-3.5 text-left shadow-[0_0_30px_rgba(255,77,77,0.2)]">
            ...
            <div className="space-y-0.5">
              <span className="text-[10px] uppercase tracking-wider text-primary font-mono font-bold block">
                Match Invitation
              </span>
              <p className="text-xs text-white font-semibold">
                Complete your username to enter Match <strong className="font-mono text-primary">#{pendingGame.id.substring(0, 6).toUpperCase()}</strong> ({pendingGame.wager ? `${pendingGame.wager} SOL` : 'Free'})
              </p>
            </div>
          </div>
        )}
