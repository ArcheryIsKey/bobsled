...
export default function Game() {
 ...
 <button
 onClick={handleLeave}
 className="flex items-center gap-2 text-xs sm:text-sm text-white font-bold py-2 sm:py-2.5 px-4 sm:px-5 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-primary transition-all shadow-md cursor-pointer group shrink-0"
 >
 ...
 <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs text-text-secondary shadow-sm">
 <span className="text-[12px] uppercase tracking-wider text-text-muted font-bold">Match</span>
 <span className="text-white font-bold">#{game.id.substring(0, 8).toUpperCase()}</span>
 </div>

 <div className="px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-bold text-white shadow-sm">
 ...
 className="px-3.5 py-1.5 rounded-full bg-primary/10 hover:bg-primary/20 text-primary border border-primary/30 hover:border-primary text-xs font-bold flex items-center gap-1.5 transition-all shadow-sm cursor-pointer"
 ...
 <div className="px-3 py-1.5 rounded-full bg-white/5 border border-white/10 flex items-center gap-1.5 text-xs">
 ...
 <div>
 <span className="text-[12px] text-text-muted uppercase tracking-wider block font-semibold">Match Info</span>
 <h2 className="font-display text-base text-white font-bold">
 #{game.id.substring(0, 8).toUpperCase()}
 </h2>
 </div>
 <span
 className={`text-[12px] px-2.5 py-0.5 rounded-full font-semibold uppercase tracking-wider ${
 game.status === 'active'
 ? 'bg-primary/10 text-primary border border-primary/30'
 : game.status === 'waiting'
 ? 'bg-yellow-500/10 text-yellow-400 border border-yellow-500/20'
 ...
 <div>
 <p className="text-[12px] text-text-muted uppercase tracking-wider mb-0.5">Stakes</p>
 ...
 {!isFreeGame && (
 <span className="text-xs text-text-secondary bg-[#1a1a1a] px-2.5 py-1 rounded-full border border-white/10 font-bold">
 SOL
 </span>
 )}
 </div>
 ...
 <span className={`text-[12px] font-semibold tracking-normal shrink-0 ${p1IsRed ? 'text-primary' : 'text-text-secondary'}`}>
 ({p1ColorLabel})
 </span>
 </p>
 ...
 <span className="absolute bg-background px-2 text-[11px] text-text-muted uppercase font-semibold tracking-wider">vs</span>
 </div>
 ...
 {game.player2 && (
 <span className={`text-[12px] font-semibold tracking-normal shrink-0 ${p2IsRed ? 'text-primary' : 'text-text-secondary'}`}>
 ({p2ColorLabel})
 </span>
 )}
 </p>
 ...
 <span className={` font-bold text-xs ${afkSecondsLeft < 15 ? 'text-primary animate-pulse' : 'text-text-secondary'}`}>
 {afkSecondsLeft}s
 </span>
 </div>
 )}
 ...
 <div className="flex items-center gap-1 text-[12px] text-primary font-semibold font-display">
 <UserPlus size={11} />
 ...
 className="flex-grow bg-background border border-white/10 text-white text-xs px-3 py-1 rounded-full focus:border-primary outline-none select-all min-w-0 font-mono tracking-tight"
 readOnly
 type="text"
 value={getInviteUrl()}
 />
 ...
 className="bg-primary hover:bg-red-600 text-white px-3 py-1 rounded-full text-xs flex items-center gap-1 transition-colors font-medium cursor-pointer shadow-md shrink-0"
 >
 ...
 <div className="space-y-1">
 <div className="flex items-center gap-1 text-[12px] text-text-secondary font-semibold font-display">
 <Eye size={11} />
 ...
 className="bg-[#1e1e1e] border border-white/10 hover:border-primary text-white px-3 py-1 rounded-full text-xs flex items-center gap-1 transition-colors font-medium cursor-pointer shrink-0"
 >
 ...
 {game.p1DepositTx && (
 <div className="pt-1.5 border-t border-white/5 flex items-center justify-between text-[12px]">
 ...
 {game.p2DepositTx && (
 <div className="pt-0.5 flex items-center justify-between text-[12px]">
 ...
 <div className="flex items-center gap-1.5 text-[12px] text-text-muted font-bold uppercase tracking-wider">
 ...
 className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-black/40 hover:bg-white/5 border border-white/5 hover:border-white/20 text-text-muted hover:text-white text-xs transition-all cursor-pointer group"
 ...
 className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#181818] border border-white/10 text-text-secondary text-xs tracking-wider shadow-md backdrop-blur-md"
 >
 ...
 <div className="lg:hidden w-full bg-white/5 border border-white/10 rounded-2xl p-3 flex items-center justify-between shadow-md text-xs">
 ...
 <p className="text-[12px] text-text-muted leading-tight">{p1ColorLabel}</p>
 </div>
 </button>

 {/* Stakes center pill */}
 <div className="px-3 py-1 rounded-full bg-background border border-white/10 text-xs text-text-secondary font-bold shrink-0 mx-2 shadow-sm">
 ...
 <p className="text-[12px] text-text-muted leading-tight">{p2ColorLabel}</p>
 </div>
 ...
 className="bg-white/5 hover:bg-red-950/40 border border-white/10 hover:border-red-900/60 text-text-secondary hover:text-red-400 px-6 py-2.5 rounded-full text-xs uppercase tracking-wider transition-all flex items-center gap-2 font-semibold cursor-pointer"
 >
 <Flag size={14} /> Resign
 </button>
 )}
 ...
 className="w-full sm:w-auto bg-primary text-white text-xs uppercase tracking-wider px-6 py-2.5 rounded-full hover:bg-red-600 transition-all shadow-[0_0_20px_rgba(255,77,77,0.6)] animate-bounce flex items-center justify-center gap-2 font-bold cursor-pointer"
 >
 ...
 <button
 onClick={() => setShowWinModal(true)}
 className="bg-white/5 hover:bg-white/10 text-white border border-white/10 hover:border-primary text-xs uppercase tracking-wider px-6 py-3 rounded-full transition-all font-bold flex items-center justify-center gap-2 cursor-pointer shadow-sm hover-magnetic"
 >
 ...
 <button
 onClick={handleLeave}
 className="bg-primary text-white text-xs uppercase tracking-wider px-8 py-3 rounded-full hover:bg-red-600 transition-all shadow-[0_0_20px_rgba(255,77,77,0.3)] font-bold flex items-center justify-center gap-2 cursor-pointer hover-magnetic btn-flashy"
 >
 ...
 className="px-6 py-2 rounded-full bg-red-600 hover:bg-red-700 text-white text-xs font-semibold transition-all shadow-[0_0_15px_rgba(255,0,0,0.4)] cursor-pointer"
 >
 Confirm Resign
 </button>
 </div>
 ...
 <span>Prize:</span>
 <SolAmount amount={game.wager * 2} className="font-bold text-primary"/>
 </div>
 {game.payoutTx ? (
 ...
 target="_blank"
 rel="noreferrer"
 className="inline-flex items-center gap-1 text-xs text-text-muted hover:text-white underline transition-colors"
 >
 ...
 <button
 onClick={() => setShowWinModal(false)}
 className="flex-1 bg-white/5 hover:bg-white/10 text-text-secondary hover:text-white py-3 rounded-full text-xs uppercase tracking-wider font-semibold border border-white/10 transition-all cursor-pointer hover-magnetic"
 >
 Review Board
 </button>
 <button
 onClick={handleLeave}
 className="flex-1 bg-primary text-white py-3 rounded-full text-xs uppercase tracking-wider font-semibold hover:bg-red-600 transition-all shadow-[0_0_20px_rgba(255,77,77,0.35)] cursor-pointer hover-magnetic btn-flashy"
 >
 Back to Lobby
 </button>
 </div>
