...
export default function ToastContainer() {
 ...
 className={`pointer-events-auto flex items-start gap-2.5 px-4 py-3 rounded-xl border backdrop-blur-xl shadow-[0_8px_30px_rgba(0,0,0,0.6)] text-xs ${COLOR_MAP[toast.type]}`}
 >
